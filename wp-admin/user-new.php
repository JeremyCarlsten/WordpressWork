            ...
            <table class="form-table">
                    ...
                    if (apply_filters('show_password_fields', true)) : ?>
                        ...
                        <tr>
                            ...
                            <td><label for="send_password"><input type="checkbox" name="send_password"
                                                                  id="send_password"
                                                                  value="1" <?php checked($new_user_send_password); ?> /> <?php _e('Send this password to the new user by email.'); ?>
                                </label></td>
                        </tr>
                    <?php endif; ?>
                <?php } // !is_multisite ?>
                ...
                <?php if (is_multisite() && is_super_admin()) { ?>
                    <tr>
                        ...
                        <td><label for="noconfirmation"><input type="checkbox" name="noconfirmation" id="noconfirmation"
