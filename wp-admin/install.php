...
<h1 id="logo"><a href="<?php echo esc_url(__('https://wordpress.org/')); ?>" tabindex="-1"><?php _e('WordPress'); ?></a>
</h1>
    ...
    <form id="setup" method="post" action="install.php?step=2" novalidate="novalidate">
        <table class="form-table">
            ...
            <tr>
                ...
                <td colspan="2"><label><input type="checkbox" name="blog_public" id="blog_public"
