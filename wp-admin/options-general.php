...
<?php if (!is_multisite()) { ?>
    ...
    <tr>
        ...
        <td><input name="home" type="url" id="home"
    ...
    <tr>
        ...
        <td><input name="admin_email" type="email" id="admin_email" value="<?php form_option('admin_email'); ?>"
...
<?php } else { ?>
    <tr>
        ...
        <td><input name="new_admin_email" type="email" id="new_admin_email" value="<?php form_option('admin_email'); ?>"
                   class="regular-text ltr"/>
