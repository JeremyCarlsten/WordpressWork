...
!function (a, b) {
    adminMenu = {init: function () {
        ...
        function d(a) {
            ...
            if (!(t || v || B.data("wp-responsive"))) {
                ...
                if (M = !0, N.menu + N.adminbar > N.window) {
                    ...
                    if (b + N.window > w.height() - 1)return void(K || (K = !0, J = !1, z.css({position: "fixed", top: "", bottom: 0})));
                    b > I ? J ? (J = !1, L = z.offset().top - N.adminbar - (b - I), L + N.menu + N.adminbar < b + N.window && (L = b + N.window - N.menu - N.adminbar), z.css({position: "absolute", top: L, bottom: ""})) : !K && z.offset().top + N.menu < b + N.window && (K = !0, z.css({position: "fixed", top: "", bottom: 0})) : I > b ? K ? (K = !1, L = z.offset().top - N.adminbar + (I - b), L + N.menu > b + N.window && (L = b), z.css({position: "absolute", top: L, bottom: ""})) : !J && z.offset().top >= b + N.adminbar && (J = !0, z.css({position: "fixed", top: "", bottom: ""})) : c && (J = K = !1, L = b + N.window - N.menu - N.adminbar - 1, L > 0 ? z.css({position: "absolute", top: L, bottom: ""}) : f())
                }
                I = b
            }
        }
        ...
        B.on("click.wp-submenu-head", ".wp-submenu-head", function (b) {
        ...
        })), t || u || (B.find("li.wp-has-submenu").hoverIntent({over: function () {
        ...
        }, timeout: 200, sensitivity: 7, interval: 90}), B.on("focus.adminmenu", ".wp-submenu a",function (b) {
            B.data("wp-responsive") || a(b.target).closest("li.menu-top").addClass("opensub")
                ...
                c(a(this))
            })), p = a("div.wrap h2:first"), p.nextAll("div.updated, div.error, div.notice").addClass("below-h2"), a("div.updated, div.error, div.notice").not(".below-h2, .inline").insertAfter(p), screenMeta.init(), a("tbody").children().children(".check-column").find(":checkbox").click(function (b) {
            ...
            w.on("wp-responsive-activate.wp-responsive",function () {
                ...
                b.preventDefault(), A.toggleClass("wp-responsive-open"), A.hasClass("wp-responsive-open") ? (a(this).find("a").attr("aria-expanded", "true"), a("#adminmenu a:first").focus()) : a(this).find("a").attr("aria-expanded", "false")
        ...
        }}, b.wpResponsive.init(), g(), w.on("wp-window-resized.pin-menu postboxes-columnchange.pin-menu postbox-toggled.pin-menu wp-collapse-menu.pin-menu wp-scroll-start.pin-menu", g)
    }), function () {
        function c() {
