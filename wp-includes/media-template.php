...
function wp_print_media_templates()
{
    ...
    <script type="text/html" id="tmpl-media-modal">
        <div class="<?php echo $class; ?>">
            <a class="media-modal-close" href="#"><span class="media-modal-icon"><span
                class="screen-reader-text"><?php _e( 'Close media panel' ); ?></span></span></a>
    ...
    <script type="text/html" id="tmpl-uploader-inline">
		...
		<?php if ( ! _device_can_upload() ) : ?>
                                ...
                                <h3
                                class="upload-instructions"><?php printf( __('The web browser on your device cannot be used to upload files. You may be able to use the <a href="%s">native app for your device</a> instead.'), 'https://apps.wordpress.org/' ); ?></h3>
		...
		<?php else : ?>
				...
				?></p>
						...
						<?php _e( 'Suggested image dimensions:' ); ?> {{data.suggestedWidth}} &times;
                                                ...
                                                <# if ( data.width ) { #>width="{{ data.width }}"
                                                    <# } #>
                                                        <# if ( data.height ) { #>height="{{ data.height }}"
                                                            <# } #>
                                                                <# if ( data.image && data.image.src !== data.icon ) { #>
                                            ...
                                            <# } #>
                                                ...
                                                <div class="attachment-actions">
                                                    <# if ( 'image' === data.type && ! data.uploading && data.sizes && data.can.save ) { #>
                                                        <a class="button edit-attachment"
                                                           href="#"><?php _e( 'Edit Image' ); ?></a>
                                                        <# } #>
                                                </div>
            </div>
        </div>
                                ...
                                <# if ( data.fileLength ) { #>
                                    ...
                                    <# } #>
                                        ...
                                        <# if ( 'audio' === data.type && data.meta.bitrate ) { #>
                                            <div class="bitrate">
                                                <strong><?php _e( 'Bitrate:' ); ?></strong> {{ Math.round(
                                                data.meta.bitrate / 1000 ) }}kb/s
    ...
    <script type="text/html" id="tmpl-attachment">
        ...
        <# if ( data.buttons.check ) { #>
            <a class="check" href="#" title="<?php esc_attr_e('Deselect'); ?>" tabindex="-1">
            ...
            <div class="details">
                ...
                <# if ( 'image' === data.type && ! data.uploading ) { #>
					...
					<?php if ( MEDIA_TRASH ): ?>
                                                    ...
                                                    <# if ( 'trash' === data.status ) { #>
                                                        <a class="untrash-attachment"
                                                           href="#"><?php _e( 'Untrash' ); ?></a>
                                                        <# } else { #>
                                                            <a class="trash-attachment"
                                                               href="#"><?php _ex( 'Trash', 'verb' ); ?></a>
                                                            <# } #>
					<?php else: ?>
						<a class="delete-attachment" href="#"><?php _e( 'Delete Permanently' ); ?></a>
					<?php endif; ?>
    ...
    <script type="text/html" id="tmpl-playlist-settings">
        ...
        <# var emptyModel = _.isEmpty( data.model ),
            ...
            <# if ( ! isVideo ) { #>
                <label class="setting">
                    <input type="checkbox" data-setting="artists"
                    <# if ( emptyModel ) { #>
                        checked="checked"
                        <# } #> />
                        ...
                        <# if ( 'undefined' !== typeof data.attachment.sizes ) { #>
									...
									foreach ( $sizes as $value => $name ) : ?>
                                        ...
                                        <#
                                            ...
                                            <option value="<?php echo esc_attr( $value ); ?>">
												<?php echo esc_html( $name ); ?> &ndash; {{ size.width }} &times; {{
                                                size.height }}
                                            </option>
                                            <# } #>
									<?php endforeach; ?>
                            ...
                            <# } #>
                                <div class="custom-size<# if ( data.model.size !== 'custom' ) { #> hidden<# } #>">
                                    <label><span><?php _e( 'Width' ); ?> <small>(px)</small></span> <input
                                        data-setting="customWidth" type="number" step="1"
                                        value="{{ data.model.customWidth }}"/></label><span
                                    class="sep">&times;</span><label><span><?php _e( 'Height' ); ?> <small>(px)</small></span><input
                                    data-setting="customHeight" type="number" step="1"
								...
								<?php esc_attr_e('None'); ?>
                                    ...
                                    <div class="advanced-section">
                                        <h3><a class="advanced-toggle" href="#"><?php _e('Advanced Options'); ?></a>
                                        </h3>
                                        ...
                                        <div class="advanced-settings hidden">
                                            ...
                                            <div class="advanced-link">
                                                <div class="setting link-target">
                                                    <label><input type="checkbox" data-setting="linkTargetBlank"
                                                                  value="_blank"
                                                ...
                                                <label class="setting link-rel">
                                                    ...
                                                    <input type="text" data-setting="linkRel"
                                        ...
                                        <div class="setting">
                                            ...
                                            <div class="button-large">
                                                <# _.each( html5types, function (mime, type) { #>
                                                    <button class="button add-media-source" data-mime="{{ mime }}">{{
                                                        type }}
                                                    </button>
                                                    <# } ) #>
                                            </div>
                                        ...
                                        <# } #>
                                            ...
                                            <div class="setting preload">
                                                ...
                                                <div class="button-group button-large" data-setting="preload">
                                                    <button class="button"
                                                            value="auto"><?php _ex( 'Auto', 'auto preload' ); ?></button>
                                                    <button class="button"
                                                            value="metadata"><?php _e( 'Metadata' ); ?></button>
                                                    <button class="button active"
                                                            value="none"><?php _e( 'None' ); ?></button>
                                                </div>
                                            </div>
            ...
            <div class="media-embed media-embed-details">
				...
				<?php wp_underscore_video_template() ?>
                            ...
                            <# if ( ! _.isEmpty( data.model.src ) ) {
                                ...
                                <label class="setting">
                                    <span>SRC</span>
                                    <input type="text" disabled="disabled" data-setting="src"
                        ...
                        <# } #>
                            ...
                            <# if ( ! _.isEmpty( data.model.poster ) ) { #>
                                <label class="setting">
                                    ...
                                    <input type="text" disabled="disabled" data-setting="poster"
