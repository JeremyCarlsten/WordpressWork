...
!function (e, t) {
    ...
    r(l, [], function () {
        ...
        return{trim: n, isArray: y, is: r, toArray: i, makeMap: o, each: a, map: s, grep: l, inArray: u, extend: d, create: c, walk: f, createNS: p, resolve: h, explode: m, _addCacheSuffix: g}
        ...
        }, push: _, sort: [].sort, splice: [].splice}, r.extend(f, {extend: r.extend, makeArray: function (e) {
            return s(e) || e.nodeType ? [e] : r.toArray(e)
        }, inArray: p, isArray: r.isArray, each: m, trim: h, grep: g, find: n, expr: n.selectors, unique: n.uniqueSort, text: n.getText, contains: n.contains, filter: function (e, t, n) {
            var r = t.length;
        ...
        }, i.ie && i.ie < 8 && (x(D, "get", {maxlength: function (e) {
            var t = e.maxLength;
        ...
        }}), x(D, "set", {"class": function (e, t) {
            e.className = t
        }, style: function (e, t) {
            e.style.cssText = t
        }})), i.ie && i.ie < 9 && (B["float"] = "styleFloat", x(L, "set", {opacity: function (e, t) {
            var n = e.style;
        ...
        return function (t, n) {
            ...
            function i(n, i, l) {
                ...
                var m, g, v, y;
                if (n = e._addCacheSuffix(n), a[n] ? y = a[n] : (y = {passed: [], failed: []}, a[n] = y), i && y.passed.push(i), l && y.failed.push(l), 1 != y.status) {
        ...
        return f.prototype = {$$: function (e) {
            ...
            return t !== f.DOM && n === document ? void f.DOM.loadCSS(e) : (e || (e = ""), r = n.getElementsByTagName("head")[0], void p(e.split(","), function (e) {
                var i;
                e = c._addCacheSuffix(e), t.files[e] || (t.files[e] = !0, i = t.create("link", {rel: "stylesheet", href: e}), v && n.documentMode && n.recalc && (i.onload = function () {
        ...
        return o = new RegExp(["<span[^>]+data-mce-bogus[^>]+>[\u200b\ufeff]+<\\/span>", '\\s?data-mce-selected="[^"]+"'].join("|"), "gi"), function (n) {
            function a() {
                var e = n.getContent({format: "raw", no_events: 1}), t = /<(\w+) [^>]*data-mce-bogus="all"[^>]*>/g, a, s, l, c, u, d = n.schema;
            ...
            return n.on("init", function () {
                ...
                var r = e.keyCode;
                (r >= 33 && 36 >= r || r >= 37 && 40 >= r || 45 == r || 13 == r || e.ctrlKey) && (s(), n.nodeChanged()), (46 == r || 8 == r || t.mac && (91 == r || 93 == r)) && n.nodeChanged(), f && l.typing && (n.isDirty() || (n.isNotDirty = !u[0] || a() == u[0].content, n.isNotDirty || n.fire("change", {level: u[0], lastLevel: null})), n.fire("TypingUndo"), f = !1, n.nodeChanged())
            ...
            }), l = {data: u, typing: !1, beforeChange: function () {
        ...
        return v = {$: t, majorVersion: "4", minorVersion: "1.7", releaseDate: "2014-11-27", editors: [], i18n: s, activeEditor: null, setup: function () {
