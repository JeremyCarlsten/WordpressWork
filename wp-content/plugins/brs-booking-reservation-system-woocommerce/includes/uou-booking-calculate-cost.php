            ...
            <table class='uou-options-table'>
                <tr>
                    <td>
                        ...
                        ?>
                        <h5 class="uou-cart-title"><?php _e('Resource: ', 'uou-bookings') ?>
                            <small>
                                <?php
                        ...
                        <h5 class="uou-cart-title"><?php _e('Person: ', 'uou-bookings') ?>
                            <small>
                        ...
                        if (isset($date_range) && is_array($date_range)) {
                            ...
                            foreach ($date_range as $keys => $values) {
                                ...
                                if ($cart_item_key['product_id'] == $keys) {
                                    ...
                                    ?>
                                    <h5 class="uou-cart-title"><?php _e('check in : ', 'uou-bookings'); ?>
                                        <small><?php echo $check_in_date; ?></small>
                                    </h5>
                                    <h5 class="uou-cart-title"><?php _e('check out : ', 'uou-bookings'); ?>
                                        <small><?php echo $check_out_date; ?></small>
                                    </h5>
                                <?php
                                }
                            }
                        ...
                        ?>
                        <h5 class="uou-cart-title"><?php _e('total_days: ', 'uou-bookings') ?>
                            <small>
