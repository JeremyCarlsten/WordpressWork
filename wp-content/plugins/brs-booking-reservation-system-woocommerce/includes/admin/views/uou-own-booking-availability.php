<div id="bookings_availability" class="panel woocommerce_options_panel">
    ...
    <ul class="nav nav-tabs" role="tablist">
        ...
        <li class="active">
            <a href="#own_tab" role="tab" data-toggle="tab"
               rel="own"><?php _e('Own Availibility', 'uou-bookings') ?></a>
        </li>
        <li>
            <a href="#resource_tab" role="tab" data-toggle="tab"
               rel="resource"><?php _e('Manage Resource', 'uou-bookings') ?></a>
        </li>
    ...
    <div class="tab-content">
                ...
                <div class="table_grid">
                    <table class="widefat">
                        ...
                        <tr>
                            ...
                            <th><?php _e('Bookable', 'uou-bookings'); ?>&nbsp;<a class="tips"
                                                                                 data-tip="<?php _e('Please select the date range for which you want the product to be disabled.', 'uou-bookings'); ?>">[?]</a>
                            </th>
                        ...
                        <tr>
                            <th colspan="6">
                                ...
                                <span
                                    class="description"><?php _e('Please select the date range to be disabled for the product.', 'uou-bookings'); ?></span>
                            </th>
                        </tr>
                        </tfoot>
        ...
        <div class="tab-pane" id="resource_tab">
            <div class="alert alert-success" role="alert"
                 style="display: none;"><?php _e('Successfully done !', 'uou-bookings') ?></div>

            <button type="button" class="button" id="save_uou_availibility"><?php _e('save', 'uou-bookings') ?></button>
            <button type="button" class="button button-primary"
                    id="add_uou_availibility"><?php _e('Add', 'uou-bookings') ?></button>
    ...
    <div class="repeatable_availibility">
        <div class="availibility_head">
            <button type="button" class="button"
                    id="remove_uou_availibility"><?php _e('Remove', 'uou-bookings') ?></button>
            <button type="button" class="button"
                    id="show_uou_availibility"><?php _e('show/hide', 'uou-bookings') ?></button>
        </div>
        <div class="availibility_main">
            <p class="form-field">
                <label><?php _e('Select availibility Type', 'uou-bookings'); ?></label>
                <select name="uou_booking_resouce_availibility" class="uou_booking_resouce_availibility_class"
                    ...
                    <?php if ($the_query->have_posts()) : ?>
                        ...
                        <?php while ($the_query->have_posts()) : $the_query->the_post(); ?>
                            <option
                                value="<?php echo get_the_ID(); ?>"><?php _e(the_title(), 'uou-bookings'); ?></option>
                        <?php endwhile; ?>
                        <!-- end of the loop -->
                    ...
                    <?php else: ?>
                        <option
                            value="own_available"><?php _e('Sorry No Resource were found', 'uou-bookings'); ?></option>
                    <?php endif; ?>
