<div class="options_group show_if_uou" id="uou_repeatable_place">
    ...
    <div class="alert alert-danger save-product" role="alert"
         style="display: none;"><?php _e('Please publish or draft the post first !', 'uou-bookings') ?></div>
    <div class="alert alert-danger resource_override" role="alert"
         style="display: none;"><?php _e('Resouce names exists, Please choose another Resouce names !', 'uou-bookings') ?></div>

    <button type="button" class="button" id="save_uou_attribute"><?php _e('save', 'uou-bookings') ?></button>
    <button type="button" class="button button-primary"
            id="add_uou_attribute"><?php _e('Add', 'uou-bookings') ?></button>
    <br>
    <hr>
                ...
                <div class="uou_repeatable">
                    ...
                    <div class="header_part">
                        <button type="button" class="button"
                                id="remove_uou_attribute"><?php _e('Remove', 'uou-bookings') ?></button>
                        <button type="button" class="button"
                                id="show_uou_attribute"><?php _e('show/hide', 'uou-bookings') ?></button>
                    </div>
                    ...
                    <div class="main_part">
                        ...
                        <p class="form-field">
                            ...
                            <select name="_uou_booking_select_type" id="_uou_booking_select_type" class=""
                                    style="margin-right: 7px;">
                                <option
                                    value="uou_person" <?php selected(esc_attr($data[0]->value), 'uou_person'); ?>><?php _e('Person', 'uou-bookings'); ?></option>
                                <option
                                    value="uou_resource" <?php selected(esc_attr($data[0]->value), 'uou_resource'); ?>><?php _e('Resouce', 'uou-bookings'); ?></option>
                            </select>
