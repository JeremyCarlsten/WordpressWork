jQuery(function (a) {
    ...
    var b = {updateTimer: !1, dirtyInput: !1, xhr: !1, $order_review: a("#order_review"), $checkout_form: a("form.checkout"), init: function () {
        ...
        if (b.xhr && b.xhr.abort(), 0 !== a("form.checkout").size()) {
            ...
            var q = {action: "woocommerce_update_order_review", security: wc_checkout_params.update_order_review_nonce, shipping_method: c, payment_method: j, country: k, state: l, postcode: m, city: n, address: o, address_2: p, s_country: d, s_state: e, s_postcode: f, s_city: g, s_address: h, s_address_2: i, post_data: a("form.checkout").serialize()};
            b.xhr = a.ajax({type: "POST", url: wc_checkout_params.ajax_url, data: q, success: function (b) {
                ...
                a(".woocommerce-checkout").find("input[name=payment_method]:checked").trigger("click"), a("body").trigger("updated_checkout")
            }})
        }
    }, submit: function () {
        ...
        if (c.triggerHandler("checkout_place_order") !== !1 && c.triggerHandler("checkout_place_order_" + a("#order_review input[name=payment_method]:checked").val()) !== !1) {
            ...
            var d = c.data();
            1 != d["blockUI.isBlocked"] && c.block({message: null, overlayCSS: {background: "#fff", opacity: .6}}), a.ajax({type: "POST", url: wc_checkout_params.checkout_url, data: c.serialize(), success: function (b) {
                var d = "";
                try {
        ...
        var c = {action: "woocommerce_apply_coupon", security: wc_checkout_params.apply_coupon_nonce, coupon_code: b.find("input[name=coupon_code]").val()};
        return a.ajax({type: "POST", url: wc_checkout_params.ajax_url, data: c, success: function (c) {
        ...
        a.ajax({type: "POST", url: wc_checkout_params.ajax_url, data: e, success: function (b) {
