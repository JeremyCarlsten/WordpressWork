...
class WC_Tax_Rate_Importer extends WP_Importer
{
    ...
    public function greet()
    {
        ...
        if (!empty($upload_dir['error'])) :
            ?>
            <div class="error">
            <p><?php _e('Before you can upload your import file, you will need to fix the following error:', 'woocommerce'); ?></p>
            ...
            <form enctype="multipart/form-data" id="import-upload-form" method="post"
                ...
                <p class="submit">
                    <input type="submit" class="button"
                           value="<?php esc_attr_e('Upload file and import', 'woocommerce'); ?>"/>
                </p>
            </form>
        <?php
        endif;
