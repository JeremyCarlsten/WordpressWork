        ...
        <ul class="order_actions submitbox">
            ...
            <li class="wide" id="actions">
                <select name="wc_order_action">
                    ...
                    <option
                        value="regenerate_download_permissions"><?php _e('Generate download permissions', 'woocommerce'); ?></option>
                ...
                <button class="button wc-reload" title="<?php _e('Apply', 'woocommerce'); ?>">
                ...
                <div id="delete-action"><?php
                    ...
                    if (current_user_can('delete_post', $post->ID)) {
                        ...
                        ?><a class="submitdelete deletion"
                             href="<?php echo esc_url(get_delete_post_link($post->ID)); ?>"><?php echo $delete_text; ?></a><?php
                    }
                    ?></div>

                <input type="submit" class="button save_order button-primary tips" name="save"
                       value="<?php printf(__('Save %s', 'woocommerce'), $order_type_object->labels->singular_name); ?>"
                       data-tip="<?php printf(__('Save/update the %s', 'woocommerce'), $order_type_object->labels->singular_name); ?>"/>
            </li>
