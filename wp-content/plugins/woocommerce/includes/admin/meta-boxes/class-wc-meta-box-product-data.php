    ...
    public static function output($post)
    {
                    ...
                    for="product_length"><?php echo __('Dimensions', 'woocommerce') . ' (' . get_option('woocommerce_dimension_unit') . ')'; ?></label>
							<span class="wrap">
								...
								<input placeholder="<?php _e('Width', 'woocommerce'); ?>"
                                       class="input-text wc_input_decimal" size="6" type="text" name="_width"
        ...
        <div id="product_attributes" class="panel wc-metaboxes-wrapper">
            ...
            <p class="toolbar">
                ...
                <button type="button"
                        class="button save_attributes"><?php _e('Save attributes', 'woocommerce'); ?></button>
            </p>
        ...
        <div id="linked_product_data" class="panel woocommerce_options_panel">
            ...
            <div class="options_group">
                ...
                <p class="form-field"><label for="upsell_ids"><?php _e('Up-Sells', 'woocommerce'); ?></label>
                    <input type="hidden" class="wc-product-search" style="width: 50%;" id="upsell_ids" name="upsell_ids"
                    ...
                    ?>" value="<?php echo implode(',', array_keys($json_ids)); ?>"/> <img class="help_tip"
                                                                                          data-tip='<?php _e('Up-sells are products which you recommend instead of the currently viewed product, for example, products that are more profitable or better quality or more expensive.', 'woocommerce') ?>'
                ...
                <p class="form-field"><label for="crosssell_ids"><?php _e('Cross-Sells', 'woocommerce'); ?></label>
                    ...
                    echo esc_attr(json_encode($json_ids));
                    ?>" value="<?php echo implode(',', array_keys($json_ids)); ?>"/> <img class="help_tip"
                                                                                          data-tip='<?php _e('Cross-sells are products which you promote in the cart, based on the current product.', 'woocommerce') ?>'
                                                                                          src="<?php echo WC()->plugin_url(); ?>/assets/images/help.png"
                                                                                          height="16" width="16"/></p>
    ...
    public static function output_variations()
    {
        ...
        <?php if (!$variation_attribute_found) : ?>
            ...
            <div id="message" class="inline woocommerce-message">
                ...
                <p class="submit"><a class="button-primary"
                                     href="<?php echo esc_url(apply_filters('woocommerce_docs_url', 'http://docs.woothemes.com/document/product-variations', 'product-variations')); ?>"
        ...
        <?php else : ?>
            ...
            <p class="toolbar">
                ...
                <select id="field_to_edit">
                    ...
                    <optgroup label="<?php esc_attr_e('Status', 'woocommerce'); ?>">
                        <option
                            value="toggle_enabled"><?php _e('Toggle &quot;Enabled&quot;', 'woocommerce'); ?></option>
                        <option
                            value="toggle_downloadable"><?php _e('Toggle &quot;Downloadable&quot;', 'woocommerce'); ?></option>
                        <option
                            value="toggle_virtual"><?php _e('Toggle &quot;Virtual&quot;', 'woocommerce'); ?></option>
                    ...
                    <optgroup label="<?php esc_attr_e('Pricing', 'woocommerce'); ?>">
                        ...
                        <option
                            value="variable_regular_price_increase"><?php _e('Prices increase by (fixed amount or %)', 'woocommerce'); ?></option>
                        <option
                            value="variable_regular_price_decrease"><?php _e('Prices decrease by (fixed amount or %)', 'woocommerce'); ?></option>
                        <option value="variable_sale_price"><?php _e('Sale prices', 'woocommerce'); ?></option>
                        <option
                            value="variable_sale_price_increase"><?php _e('Sale prices increase by (fixed amount or %)', 'woocommerce'); ?></option>
                        <option
                            value="variable_sale_price_decrease"><?php _e('Sale prices decrease by (fixed amount or %)', 'woocommerce'); ?></option>
                        <option
                            value="variable_sale_schedule"><?php _e('Scheduled sale dates', 'woocommerce'); ?></option>
                    </optgroup>
                    <optgroup label="<?php esc_attr_e('Inventory', 'woocommerce'); ?>">
                        <option
                            value="toggle_manage_stock"><?php _e('Toggle &quot;Manage stock&quot;', 'woocommerce'); ?></option>
            ...
            <p class="toolbar">
                ...
                <button type="button"
                        class="button button-primary add_variation" <?php disabled($variation_attribute_found, false); ?>><?php _e('Add Variation', 'woocommerce'); ?></button>

                <button type="button"
                        class="button link_all_variations" <?php disabled($variation_attribute_found, false); ?>><?php _e('Link all variations', 'woocommerce'); ?></button>

                <strong><?php _e('Defaults', 'woocommerce'); ?>: <span class="tips"
                                                                       data-tip="<?php _e('These are the attributes that will be pre-selected on the frontend.', 'woocommerce'); ?>">[?]</span></strong>
                <?php
