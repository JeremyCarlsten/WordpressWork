            ...
            foreach ($options as $value) {
                ...
                switch ($value['type']) {
                    ...
                    case 'image_width' :
                        ...
                        <tr valign="top">
                        <th scope="row"
                            class="titledesc"><?php echo esc_html($value['title']) ?> <?php echo $tooltip_html;
                            echo $disabled_message; ?></th>
                        <td class="forminp image_width_settings">

                            <input name="<?php echo esc_attr($value['id']); ?>[width]" <?php echo $disabled_attr; ?>
                            ...
                            <label><input
                                    name="<?php echo esc_attr($value['id']); ?>[crop]" <?php echo $disabled_attr; ?>
                                    id="<?php echo esc_attr($value['id']); ?>-crop" type="checkbox"
                                    value="1" <?php checked(1, $crop); ?> /> <?php _e('Hard Crop?', 'woocommerce'); ?>
                            </label>
                    ...
                    case 'single_select_country' :
                        ...
                        <td class="forminp"><select name="<?php echo esc_attr($value['id']); ?>"
                                                    ...
                                                    title="<?php _e('Country', 'woocommerce') ?>"
                    ...
                    case 'multi_select_countries' :
                        ...
                        <td class="forminp">
                            <select multiple="multiple" name="<?php echo esc_attr($value['id']); ?>[]"
                                    style="width:350px"
                                    data-placeholder="<?php _e('Choose countries&hellip;', 'woocommerce'); ?>"
                                    title="<?php _e('Country', 'woocommerce') ?>" class="wc-enhanced-select">
                                <?php
                                if ($countries) {
                                ...
                                ?>
                            </select> <?php echo ($description) ? $description : ''; ?> </br><a
                                class="select_all button" href="#"><?php _e('Select all', 'woocommerce'); ?></a> <a
