    ...
    class WC_Admin_Post_Types
    {
                                ...
                                <td class="name">
                                    <?php if ($_product) : ?>
                                        ...
                                        <a href="<?php echo get_edit_post_link($_product->id); ?>"
                                           title="<?php echo apply_filters('woocommerce_order_item_name', $item['name'], $item); ?>"><?php echo apply_filters('woocommerce_order_item_name', $item['name'], $item); ?></a>
                                    <?php else : ?>
        ...
        public function shop_order_filters()
        {
            ...
            <input type="hidden" class="wc-customer-search" name="_customer_user"
                   data-placeholder="<?php _e('Search for a customer&hellip;', 'woocommerce'); ?>"
        ...
        public function edit_form_after_title($post)
        {
            if ('shop_coupon' === $post->post_type) {
                ...
                <textarea id="woocommerce-coupon-description" name="excerpt" cols="5" rows="2"
                          placeholder="<?php esc_attr_e('Description (optional)', 'woocommerce'); ?>"><?php echo esc_textarea($post->post_excerpt); ?></textarea>
            <?php
            }
        }
        ...
        public function product_data_visibility()
        {
            ...
            <div class="misc-pub-section" id="catalog-visibility">
                ...
                <a href="#catalog-visibility"
                   class="edit-catalog-visibility hide-if-no-js"><?php _e('Edit', 'woocommerce'); ?></a>
                ...
                <div id="catalog-visibility-select" class="hide-if-js">
                    ...
                    <p>
                        <a href="#catalog-visibility"
                           class="save-post-visibility hide-if-no-js button"><?php _e('OK', 'woocommerce'); ?></a>
                        <a href="#catalog-visibility"
                           class="cancel-post-visibility hide-if-no-js"><?php _e('Cancel', 'woocommerce'); ?></a>
                    </p>
                </div>
            </div>
        <?php
