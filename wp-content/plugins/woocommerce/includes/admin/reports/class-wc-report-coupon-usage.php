        ...
        <div class="section">
            <form method="GET">
                <div>
                    ...
                    if ($used_coupons) :
                        ?>
                        <select id="coupon_codes" name="coupon_codes" class="wc-enhanced-select"
                                data-placeholder="<?php _e('Choose coupons&hellip;', 'woocommerce'); ?>"
                                style="width:100%;">
                        ...
                        <input type="hidden" name="tab"
                               value="<?php if (!empty($_GET['tab'])) echo esc_attr($_GET['tab']) ?>"/>
            ...
            jQuery(function () {
                ...
                var drawGraph = function (highlight) {
                    ...
                    },
                    {
                        ...
                        data: order_data
                .
                order_discount_amounts,
                    yaxis
                :
                2,
                    color
                :
                '<?php echo $this->chart_colours['discount_amount']; ?>',
                    points
                :
                {
                    show: true, radius
