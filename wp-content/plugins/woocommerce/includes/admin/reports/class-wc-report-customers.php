            ...
            jQuery(function () {
                    ...
                    var drawGraph = function (highlight) {
                            ...
                            true,
                                append_tooltip
                            :
                            "<?php echo ' ' . __( 'customer orders', 'woocommerce' ); ?>",
                                stack
                            :
                            true,
                        },
                    ...
                    guest_orders,
                        color
                    :
                    '<?php echo $this->chart_colours['guests']; ?>',
                        bars
                    :
                    {
                        fillColor: '<?php echo $this->chart_colours['guests']; ?>', fill
                    :
                        true, show
                    :
                        true, lineWidth
                    ...
                    true,
                        append_tooltip
                    :
                    "<?php echo ' ' . __( 'guest orders', 'woocommerce' ); ?>",
                        stack
                    :
                    true,
                },
