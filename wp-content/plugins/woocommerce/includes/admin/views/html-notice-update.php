...
<div id="message" class="updated woocommerce-message wc-connect">
    ...
    <p class="submit"><a
            href="<?php echo esc_url(add_query_arg('do_update_woocommerce', 'true', admin_url('admin.php?page=wc-settings'))); ?>"
            class="wc-update-now button-primary"><?php _e('Run the updater', 'woocommerce'); ?></a></p>
</div>
