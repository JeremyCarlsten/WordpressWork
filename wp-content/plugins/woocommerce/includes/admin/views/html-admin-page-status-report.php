...
<div class="updated woocommerce-message">
    ...
    <p class="submit"><a href="#"
                         class="button-primary debug-report"><?php _e('Get System Report', 'woocommerce'); ?></a>
        <a class="skip button-primary"
           href="http://docs.woothemes.com/document/understanding-the-woocommerce-system-status-report/"
           target="_blank"><?php _e('Understanding the Status Report', 'woocommerce'); ?></a></p>
    ...
    <div id="debug-report">
        ...
        <p class="submit">
            <button id="copy-for-support" class="button-primary" href="#"
                    data-tip="<?php _e('Copied!', 'woocommerce'); ?>"><?php _e('Copy for Support', 'woocommerce'); ?></button>
        </p>
    </div>
</div>
<br/>
<table class="wc_status_table widefat" cellspacing="0" id="status">
    ...
    <tr>
        <th colspan="3"
            data-export-label="WordPress Environment"><?php _e('WordPress Environment', 'woocommerce'); ?></th>
    </tr>
    </thead>
    <tbody>
    <tr>
...
<table class="wc_status_table widefat" cellspacing="0" id="status">
    ...
    <tr>
        <th colspan="3"
            data-export-label="Active Plugins (<?php echo count((array)get_option('active_plugins')); ?>)"><?php _e('Active Plugins', 'woocommerce'); ?>
...
<table class="wc_status_table widefat" cellspacing="0" id="status">
    ...
    <tr>
        <th colspan="3"
            data-export-label="Taxonomies"><?php _e('Taxonomies', 'woocommerce'); ?><?php echo ' <a href="#" class="help_tip" data-tip="' . esc_attr__('A list of taxonomy terms that can be used in regard to order/product statuses.', 'woocommerce') . '">[?]</a>'; ?></th>
    </tr>
    </thead>
    <tbody>
    <tr>
...
<table class="wc_status_table widefat" cellspacing="0" id="status">
    ...
    <tr>
        <th colspan="3"
            data-export-label="Templates"><?php _e('Templates', 'woocommerce'); ?><?php echo ' <a href="#" class="help_tip" data-tip="' . esc_attr__('This section shows any files that are overriding the default WooCommerce template pages.', 'woocommerce') . '">[?]</a>'; ?></th>
    </tr>
    </thead>
    <tbody>
    <?php
    ...
    if ($found_files) {
        foreach ($found_files as $plugin_name => $found_plugin_files) {
            ?>
            <tr>
                <td data-export-label="Overrides"><?php _e('Overrides', 'woocommerce'); ?> (<?php echo $plugin_name; ?>
                    ):
                </td>
                <td class="help">&nbsp;</td>
    ...
    if (true === $outdated_templates) {
        ...
        <tr>
            <td>&nbsp;</td>
            <td class="help">&nbsp;</td>
            <td><a href="http://speakinginbytes.com/2014/02/woocommerce-2-1-outdated-templates/"
                   target="_blank"><?php _e('Learn how to update outdated templates', 'woocommerce') ?></a></td>
        </tr>
    <?php
    }
    ?>
